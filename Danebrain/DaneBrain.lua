...
--ActionButton1:SetPoint("CENTER",-233,-30) 
--ActionButton1.SetPoint = function() end

--MultiBarBottomLeftButton1:ClearAllPoints()
--MultiBarBottomLeftButton1:SetPoint("CENTER",-233, -13)
--MultiBarBottomLeftButton1.SetPoint = function() end

--ActionButton1:ClearAllPoints()
--ActionButton1:SetPoint("CENTER",-350,-30)
--ActionButton1.SetPoint = function() end
...
--MultiBarBottomRightButton7:ClearAllPoints() MultiBarBottomRightButton7:SetPoint("CENTER",-148,37)
